            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1 mg-b-5" style="background-color:white;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">PA with Aging</li>
                    </ol>
                </nav>
                <h4 class="mg-b-0 tx-spacing--1">Purchase Advice with Aging</h4>
                {{--
                        ...
                        <div class="col-12 mx-0 mb-2 p-0">
                            <form class="form-inline" id="searchForm" style="font-size: 12px;">
                                    ...
                                    <div class="col-2 p-0 m-0 text-center">
                                        ...
                                        <a class="btn btn-sm btn-secondary px-4" href="{{route('mcd.pa_aging')}}">Reset</a>
                                    </div>
                            </form>
                        </div>
...
@section('pagejs')
    ...
    <script>
        let listingUrl = "{{ route('mcd.pa_aging') }}";
