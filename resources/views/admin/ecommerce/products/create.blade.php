            ...
            <div class="row row-sm">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input name="code" id="code" value="{{ old('code') }}" type="text" class="form-control @error('code') is-invalid @enderror" maxlength="150">
                        @error('code')
                ...
                <div class="col-lg-6 mg-t-20">
                    ...
                    <div class="form-group">
                        ...
                        <input name="critical_qty" id="critical_qty" value="{{ old('critical_qty', 0) }}" type="number" min="0" class="form-control @error('critical_qty') is-invalid @enderror" maxlength="250">
                        @error('critical_qty')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
