        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Edit a Stock Category</li>
                </ol>
            </nav>
            <h4 class="mg-b-0 tx-spacing--1">Edit a Stock Category</h4>
        </div>
    </div>
        ...
        <div class="col-md-6">
            <form action="{{ route('product-categories.update',$category->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group {{ $errors->has('category_image') ? 'has-error' : '' }}">
                        ...
                        @else
                            <div>
                                <img src="{{ asset('storage/images/'.$category->image) }}" id="img_temp" height="100" width="300" alt="Company Logo" style="max-width: 100%;">  <br /><br />
