<div class="modal effect-scale" id="prompt-import" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            <form method="POST" action="{{ route('products.import') }}" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Import File</h5>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-sm btn-success" id="btnDelete">Yes, Import</button>
