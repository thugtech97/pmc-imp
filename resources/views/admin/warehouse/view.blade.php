        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mg-b-5">
                    <li class="breadcrumb-item" aria-current="page"><a href="">CMS</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{route('warehouse_mrs.index')}}">MRS</a></li>
                </ol>
            </nav>
                ...
                <tbody>
                    ...
                    @forelse($salesDetails as $details)
                        ...
                        <tr class="pd-20" style="border-bottom: none;">
                            ...
                            <td class="tx-nowrap" style="padding: 10px; text-align: left; border: 1px solid #ddd; background-color: {{ $details->promo_id === '0' ? '' : '#E9EAEC' }};">{{$details->product->name}}</td>
                            ...
                            <td class="tx-right" style="padding: 10px; text-align: left; border: 1px solid #ddd; background-color: {{ $details->promo_id === '0' ? '' : '#E9EAEC' }};">
                                <input type="text" name="po_no{{ $details->id }}" value="{{ $details->po_no }}" class="form-control" disabled>
                            </td>
                            <td class="tx-right" style="padding: 10px; text-align: left; border: 1px solid #ddd; background-color: {{ $details->promo_id === '0' ? '' : '#E9EAEC' }};">
                        ...
                        <tr class="pd-20">
                            ...
                            <td colspan="10" class="tx-left" style="padding: 10px; text-align: left; border: 1px solid #ddd; background-color: {{ $details->promo_id === '0' ? '' : '#E9EAEC' }};">
                                {{$details->par_to}}<br>
                ...
                <div class="form-group"> 
                    <div style="float: right;">
                        @if($sales->received_at)
                            <button type="submit" class="btn btn-info mt-2" style="width: 140px; text-transform: uppercase;" {{ $sales->purchaseAdvice->is_hold == 0 || $sales->purchaseAdvice->is_hold == NULL ? '' : 'disabled' }}>{{ $sales->response_code ? 'Update' : 'Submit' }}</button>
                        @endif
                    </div>
                </div>
            </div>
