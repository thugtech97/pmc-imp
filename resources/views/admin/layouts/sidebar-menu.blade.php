<ul class="nav nav-aside">
    ...
    @if (auth()->user()->has_access_to_module('customer') || auth()->user()->has_access_to_module('sales_transaction') || auth()->user()->has_access_to_module('products') || auth()->user()->has_access_to_module('product_category') || auth()->user()->has_access_to_module('inventory') || auth()->user()->has_access_to_module('promos') || auth()->user()->has_access_to_module('delivery_flat_rate') || auth()->user()->has_access_to_module('coupons'))
    ...
    @if(auth()->user()->has_access_to_route('report.sales-transaction'))
