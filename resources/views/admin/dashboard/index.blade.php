    ...
    <div class="container pd-x-0">
        ...
        <div class="row row-sm">
            <div class="col-lg-12">
                ...
                <div class="row row-sm">
                    <div class="col-lg-4 col-md-6">
                        <div class="card dashboard-widget bg-success">
                            <a href="{{ route('sales-transaction.index', '&startdate='.date("Y-m-d").'&enddate=&del_status%5B%5D=&customer_filter=&search=') }}">
                                <div class="card-body">
                                    <h4 class="tx-bold mg-b-5 lh-1 text-white"><i data-feather="shopping-cart" class="mg-r-6"></i> {{ $ordersToday }}</h4>
                                    <span class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold text-white">Total
                                Number of Orders Today</span>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card dashboard-widget bg-warning">
                            <a href="{{ route('sales-transaction.index', '&startdate=&enddate=&del_status%5B%5D=APPROVED&del_status%5B%5D=PARTIAL&customer_filter=&search=') }}">
                                <div class="card-body">
                                    <h4 class="tx-bold mg-b-5 lh-1 text-white"><i data-feather="shopping-cart" class="mg-r-6"></i> {{ $totalOpenOrders }}</h4>
                                    <span class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold text-white">Total
                                Number of Open Orders</span>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card dashboard-widget bg-danger">
                            <a href="{{ route('sales-transaction.index', '&startdate='.$past.'&enddate=&del_status%5B%5D=APPROVED&customer_filter=&search=') }}">
                                <div class="card-body">
                                    <h4 class="tx-bold mg-b-5 lh-1 text-white"><i data-feather="shopping-cart" class="mg-r-6"></i> {{ $unservedOrders }}</h4>
                                    <span class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold text-white">Total
                                Number of Unserved Orders</span>
                                </div>
                            </a>
                        </div>
                    </div>
...
@section('customjs')
    <script>
        ...
        const labels = months({count: MONTHS.length});
        const data = {
            labels: labels,
        ...
        new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Total numbers of orders per department'
                    }
                },
                scales: {
                    x: {
