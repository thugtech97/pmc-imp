<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element slider-parallax min-vh-100" style="background: url('images/slider/swiper/home-bg.png') center center; background-size: cover;">
			<div class="slider-inner">
				<div class="bg-overlay-bg bg-overlay-gold"></div>
