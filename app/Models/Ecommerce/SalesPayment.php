...
class SalesPayment extends Model
{
    ...
    protected $fillable = ['sales_header_id','payment_type','amount','status', 'payment_date', 'receipt_number','created_by','remarks','response_body','response_id','response_code', 'is_verified', 'attachment', 'admin_remarks'
];
