...
class History
{
    ...
    protected static function describeImfStatus($status)
    {
        ...
        $map = [
            ...
            Status::FOR_VERIFICATION   => ['endorsed',  'Endorsed by the MCD Planner to the MCD Verifier', 'Reviewed by MCD Planner - for MCD Verifier'],
            Status::VERIFIED_MCD       => ['verified',  'Verified by the MCD Verifier',            'Verified by MCD Verifier - for MCD Planner stock code'],
            Status::HOLD_MCD_VERIFIER  => ['held',      'Held by the MCD Verifier for Planner re-edit', 'On hold - with MCD Planner for re-edit'],
            Status::REJECTED_MCD_VERIFIER => ['cancelled', 'Rejected by the MCD Verifier',         'Rejected by MCD Verifier'],
            Status::APPROVED_MCD       => ['verified',  'Approved by the MCD Planner',             'Approved by MCD Planner - for Planning Supervisor'],
            Status::APPROVED_SUPERVISOR => ['approved', 'Approved by the Planning Supervisor',     'Approved by Planning Supervisor'],
            Status::HOLD_PLANNER       => ['returned',  'Returned to the requestor by the MCD Planner', 'Returned to you for revision - MCD Planner'],
            Status::HOLD_SUPERVISOR    => ['held',      'Held by the Planning Supervisor for Planner re-edit', 'On hold - with MCD Planner for re-edit'],
            Status::REJECTED_PLANNER   => ['cancelled', 'Rejected by the MCD Planner',             'Rejected by MCD Planner'],
            Status::REJECTED_SUPERVISOR => ['cancelled', 'Rejected by the Planning Supervisor',    'Rejected by Planning Supervisor'],
            // Legacy — IMFs decided before the Planning Supervisor took over the stage.
