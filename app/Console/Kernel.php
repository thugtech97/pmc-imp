...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        // Send email notification to admin if there is an item inventory need to be updated.
        $schedule->command('reorder_point_notification:cron')
                 ->hourly();

        $schedule->command('announcements:activate')
                 ->daily();
    }
